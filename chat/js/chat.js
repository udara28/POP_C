...
var ajaxChat = {
    ...
    getChatListMessageString: function(dateObject, userID, userName, userRole, messageID, messageText, channelID, ip) {
        ...
        var splitChat = messageText.split("[[@#]]");
        messageText = splitChat[0];
        var senderComId = splitChat[1];
        var senderDicId = splitChat[2];
        ...
        if(userID == currentUser){
            ...
            translate(
                '{"api_key":"12yui3244",' +
                    '"correlation_id":"123", ' +
                    '"message": "'+messageText+'", ' +
                    '"sender_communityId" :"'+userComList+'", ' +
                    '"sender_dictionaryId" : "'+userDictList+'", ' +
                    '"receiver_communityId" :"'+userComList+'", ' +
                    '"receiver_dictionaryId": "'+userDictList+'", ' +
            ...
            translate(
                '{"api_key":"12yui3244",' +
                    '"correlation_id":"123", ' +
                    '"message": "'+messageText+'", ' +
                    '"sender_communityId" :"'+senderComId+'", ' +
                    '"sender_dictionaryId" : "'+senderDicId+'", ' +
                    '"receiver_communityId" :"'+userComList+'", ' +
                    '"receiver_dictionaryId": "'+userDictList+'", ' +
                    '"time" : "12222222"}', "chat", "chatMsgId"+this.getMessageDocumentID(messageID));
        }
    ...
    sendMessage: function(text) {
        ...
        var userComId = $("#comList").val();
        var userDictId = $("#dictList").val();

        text = text + "[[@#]]"+userComId+"[[@#]]"+userDictId;
