...
function merge2($img_left, $img_right, $filename_result) {

 // Get dimensions for specified images

 list($width_x, $height_x) = getimagesize($img_left);
 list($width_y, $height_y) = getimagesize($img_right);
 ...
 $image_x = imagecreatefromjpeg($img_left);
 $image_y = imagecreatefromgif($img_right);
